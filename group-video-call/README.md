# PlanetKit quick start for iOS (Group Video Call)
...
- [API Reference](https://docs.lineplanet.me/api-reference/client/ios/6.0/index.html)
...
Open Xcode project `planet-kit-quickstart-ios-group-video-call.xcodeproj` with Xcode.
...
Run the quick start project on an iOS device or iOS simulator with scheme `planet-kit-quickstart-ios-group-video-call.xcodeproj`.
...
<img width="400px" src="./images/request_peer_video.jpg"/>
...
If the group call cannot be connected, please check [PlanetKitStartFailReason](https://docs.lineplanet.me/api-reference/client/ios/6.0/Enums/PlanetKitStartFailReason.html) and [PlanetKitDisconnectReason](https://docs.lineplanet.me/api-reference/client/ios/6.0/Enums/PlanetKitDisconnectReason.html).
